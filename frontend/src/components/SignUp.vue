<template>
    <div class="sign_up">
            <div class="sign_up_el">
                <div class="logo">
                    <img class="logo_1" src="../../public/img/login_img.png"/>
                </div>
        ...
        <div class="sign_up_privacy">By creating an account you agree to our <a href="#" style="color:dodgerblue">Terms & Privacy</a></div>
    </div>
</template>
